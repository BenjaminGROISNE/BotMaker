...
std::string templates = ".\\assets\\templates\\";
std::string backg = ".\\assets\\liveScreenshot\\screenshot.png";
std::string back = templates + "back.png";
std::string tapblank = templates + "tapblank.png";
std::string youreceived = templates + "youreceived.png";

//Abode
std::string Abode = templates + "Abode\\";
...
std::string eightlawlvl = Laws + "eightlawlvl.png";
std::string firelaw = Laws + "firelaw.png";
std::string fivelawlvl = Laws + "fivelawlvl.png";
std::string fourlawlevel = Laws + "fourlawlevel.png";
std::string greenfruit = Laws + "greenfruit.png";
std::string lawxp = Laws + "lawxp.png";
std::string metallaw = Laws + "metallaw.png";
std::string ninelawlvl = Laws + "ninelawlvl.png";
std::string ninelearn = Laws + "ninelearn.png";
...
std::string onelawlevel = Laws + "onelawlevel.png";
std::string onelearn = Laws + "onelearn.png";
...
std::string sevenlawlvl = Laws + "sevenlawlvl.png";
std::string sevenlearn = Laws + "sevenlearn.png";
std::string sixlawlvl = Laws + "sixlawlvl.png";
std::string sixlearn = Laws + "sixlearn.png";
std::string threelawlvl = Laws + "threelawlvl.png";
std::string threelearn = Laws + "threelearn.png";
std::string twolawlvl = Laws + "twolawlvl.png";
std::string twolearn = Laws + "twolearn.png";
std::string waterlaw = Laws + "waterlaw.png";
std::string woodlaw = Laws + "woodlaw.png";
std::string yellowfruit = Laws + "yellowfruit.png";
std::string zerolawlvl = Laws + "zerolawlvl.png";
...
//Arena
std::string Arena = templates + "Arena\\";
...
//Assistant
std::string Assistant = templates + "Assistant\\";
...
//Backpack
std::string Backpack = templates + "Backpack\\";
...
//Gate
std::string Gate = templates + "Gate\\";
...
//Heirloom
std::string Heirloom = templates + "Heirloom\\";
...
//Launch
std::string Launch = templates + "Launch\\";
...
//Mail
std::string Mail = templates + "Mail\\";
std::string claimallmail = Mail + "claimallmail.png";

//Otherworld
std::string Otherworld = templates + "Otherworld\\";
...
//Pack
std::string Pack = templates + "Pack\\";
...
//Perks
std::string Perks = templates + "Perks\\";
...
//Ranking
std::string Ranking = templates + "Ranking\\";
...
//Realm
std::string Realm = templates + "Realm\\";

//Sect
std::string Sect = templates + "Sect\\";
...
//Town
std::string Town = templates + "Town\\";
...
//WeeklyEvent
std::string WeeklyEvent = templates + "WeeklyEvent\\";
